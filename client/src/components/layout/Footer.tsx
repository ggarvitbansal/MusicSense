...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-gray-900 bg-black text-gray-400 py-12" role="contentinfo">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center pb-8 border-b border-gray-800">
          {/* Logo */}
          <div className="text-center md:text-left">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Understanding your music like never before.
            </p>
          </div>

          {/* Navigation Links */}
          <nav className="flex flex-wrap justify-center gap-6 text-sm font-medium" aria-label="Footer Navigation">
            <NavLink to="/" onClick={handleScrollToTop} className="hover:text-white transition-colors">
              Home
            </NavLink>
          ...
          <div className="flex justify-center md:justify-end space-x-4">
            <a 
              ...
              className="p-2 bg-gray-900 border border-gray-800 rounded-lg hover:text-white hover:border-gray-700 transition-all"
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 gap-4">
          <p>&copy; {currentYear} MusicSense. All rights reserved.</p>
